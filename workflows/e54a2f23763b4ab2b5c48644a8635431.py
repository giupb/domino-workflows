...
dag_config_0 = {'start_date': '2023-05-05', 'schedule_interval': None, 'catchup': False, 'dag_id': 'e54a2f23763b4ab2b5c48644a8635431'}
...
with DAG(**dag_config) as dag:
    task_YoutubeDownloadPiece_0 = Task(
        ...
        piece_input_kwargs={'output_type': 'audio', 'containerResources': {'cpu': {'min': 100, 'max': 100}, 'memory': {'min': 128, 'max': 128}, 'useGpu': False}, 'url': 'https://www.youtube.com/watch?v=J0NuOlA2xDc&ab_channel=Coderized'}
    )()
