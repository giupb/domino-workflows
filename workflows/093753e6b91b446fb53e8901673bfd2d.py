...
dag_config_0 = {'start_date': '2023-05-05', 'schedule_interval': None, 'catchup': False, 'dag_id': '093753e6b91b446fb53e8901673bfd2d'}
...
with DAG(**dag_config) as dag:
    ...
    task_AudioTranscriptionPiece_0 = Task(
        ...
        piece_input_kwargs={'output_type': 'file', 'temperature': 0.1, 'containerResources': {'cpu': {'min': 100, 'max': 100}, 'memory': {'min': 128, 'max': 128}, 'useGpu': False}, 'file_path': {'type': 'fromUpstream', 'upstream_task_id': 'task_YoutubeDownloadPiece_0', 'output_arg': 'file_path'}, 'prompt': 'Transcritp this audio'}
    )()
