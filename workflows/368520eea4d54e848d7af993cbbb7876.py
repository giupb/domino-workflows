...
with DAG(**dag_config) as dag:
    ...
    task_TextSummarizerPiece_0 = Task(
        ...
        piece_input_kwargs={'text': None, 'openai_model': ['gpt-3.5-turbo', 4000], 'chunk_size': 1000, 'chunk_overlap_rate': 0.2, 'max_tokens': 500, 'temperature': 0.2, 'containerResources': {'cpu': {'min': 100, 'max': 100}, 'memory': {'min': 128, 'max': 128}, 'useGpu': False}}
    )()
