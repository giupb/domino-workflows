...
dag_config_0 = {'start_date': '2023-05-03', 'schedule_interval': None, 'catchup': False, 'dag_id': '368520eea4d54e848d7af993cbbb7876'}
...
with DAG(**dag_config) as dag:
    ...
    task_TextSummarizerPiece_0 = Task(
        ...
        piece_input_kwargs={'text': {'type': 'fromUpstream', 'upstream_task_id': 'task_AudioTranscriptionPiece_0', 'output_arg': 'transcription_result'}, 'openai_model': ['gpt-3.5-turbo', 4000], 'chunk_size': 1000, 'chunk_overlap_rate': 0.2, 'max_tokens': 500, 'temperature': 0.2, 'containerResources': {'cpu': {'min': 100, 'max': 100}, 'memory': {'min': 128, 'max': 128}, 'useGpu': False}}
    )()
