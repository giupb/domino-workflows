...
dag_config_0 = {'start_date': '2023-05-04', 'schedule_interval': None, 'catchup': False, 'dag_id': 'e5746382a0234027b4cb09a5ed91882f'}
...
with DAG(**dag_config) as dag:
    task_YoutubeDownloadPiece_0 = Task(
        ...
        piece_input_kwargs={'output_type': 'audio', 'containerResources': {'cpu': {'min': 100, 'max': 100}, 'memory': {'min': 128, 'max': 128}, 'useGpu': False}, 'url': 'https://www.youtube.com/watch?v=zhWDdy_5v2w&ab_channel=AsapSCIENCE', 'output_file_name': 'audio_one_minute_video'}
    )()
