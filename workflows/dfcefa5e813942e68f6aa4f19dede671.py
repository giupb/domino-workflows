...
dag_config_0 = {'start_date': '2023-05-04', 'schedule_interval': None, 'catchup': False, 'dag_id': 'dfcefa5e813942e68f6aa4f19dede671'}
...
with DAG(**dag_config) as dag:
    task_YoutubeDownloadPiece_0 = Task(
        ...
        piece={'name': 'YoutubeDownloadPiece', 'source_image': 'ghcr.io/tauffer-consulting/social_media_domino_pieces:0.1.0-group0', 'repository_id': 6},
        piece_input_kwargs={'output_type': 'audio', 'containerResources': {'cpu': {'min': 100, 'max': 100}, 'memory': {'min': 128, 'max': 128}, 'useGpu': False}, 'url': 'https://www.youtube.com/watch?v=zhWDdy_5v2w&ab_channel=AsapSCIENCE', 'output_file_name': 'what_happens_in_one_minute'}
    )()
    task_AudioTranscriptionPiece_0 = Task(
        ...
        workflow_shared_storage={'source': 'AWS S3', 'base_folder': 'folder-02', 'mode': 'Read/Write', 'provider_options': {'bucket': 'domino-shared-storage'}, 'storage_repository_id': 4},
        container_resources={'requests': {'cpu': '100.0m', 'memory': '128.0Mi'}, 'limits': {'cpu': '100.0m', 'memory': '128.0Mi'}, 'use_gpu': False},
        piece={'name': 'AudioTranscriptionPiece', 'source_image': 'ghcr.io/tauffer-consulting/openai_domino_pieces:0.1.2-group1', 'repository_id': 5},
