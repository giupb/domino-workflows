...
dag_config_0 = {'start_date': '2023-05-05', 'schedule_interval': None, 'catchup': False, 'dag_id': 'ddb33111e78a424394668f00f049197e'}
...
with DAG(**dag_config) as dag:
    ...
    task_EmailSenderPiece_0 = Task(
        ...
        piece_input_kwargs={'email_provider': 'gmail', 'containerResources': {'cpu': {'min': 100, 'max': 100}, 'memory': {'min': 128, 'max': 128}, 'useGpu': False}, 'email_receivers': 'giulio.pbrugalli@gmail.com', 'email_subject': 'Summary of the text', 'email_body': {'type': 'fromUpstream', 'upstream_task_id': 'task_TextSummarizerPiece_0', 'output_arg': 'summarized_text'}}
    )()
