...
dag_config_0 = {'start_date': '2023-05-04', 'schedule_interval': None, 'catchup': False, 'dag_id': '883cf766014a4a26a62a26362117b0b4'}
...
with DAG(**dag_config) as dag:
    task_YoutubeDownloadPiece_0 = Task(
        ...
        piece={'name': 'YoutubeDownloadPiece', 'source_image': 'ghcr.io/tauffer-consulting/social_media_domino_pieces:0.1.0-group0', 'repository_id': 4},
